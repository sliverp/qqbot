...
> **⚠️ 分支说明**
>
> 本项目是基于 [sliverp/qqbot](https://github.com/sliverp/qqbot) 的修改版分支。
>
> **主要改动：**
> - ❌ **移除了定时任务功能** - QQ 官方 API 对主动发消息有严格限制，定时消息无法可靠工作
> - ✅ **新增媒体消息接收** - 支持接收语音、图片、视频消息并进行处理
> - ✅ **新增媒体消息发送** - 支持发送语音和视频消息（原项目仅支持发送图片）
>
> 本分支主要用于个人使用，由于时间仓促，暂未向上游项目提交 PR。
